...
Plugin URI: www.ryankienstra.com/widget-rows
...
function awr_get_included_files() {
  $included_files = array(
    'bootstrap-column-classes' , 'class-awr-sidebar' , 'class-awr-markup' ,  'awr-icons-popovers' , 'awr-pages-and-sidebars' , 'awr-sidebar-options' , 'class-awr-page'
  ) ;
